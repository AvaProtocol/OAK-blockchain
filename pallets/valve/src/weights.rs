...
// Summary:
//:close_valve 20_203_000
//:open_valve 21_211_000
//:close_pallet_gate_new 23_954_000
//:close_pallet_gate_existing 14_438_000
//:open_pallet_gate 25_467_000
//:open_pallet_gates 27_864_000
//:stop_scheduled_tasks 19_909_000
//:start_scheduled_tasks 20_643_000
...
impl<T: frame_system::Config> WeightInfo for SubstrateWeight<T> {
	...
	// Storage: Valve ValveClosed (r:1 w:1)
	fn open_valve() -> Weight {
		Weight::from_ref_time(21_211_000 as u64)
			.saturating_add(T::DbWeight::get().reads(2 as u64))
			.saturating_add(T::DbWeight::get().writes(1 as u64))
	}
	// Storage: TechnicalMembership Members (r:1 w:0)
	...
	// Storage: Valve ClosedPallets (r:1 w:1)
	fn close_pallet_gate_existing() -> Weight {
		Weight::from_ref_time(14_438_000 as u64)
	...
	// Storage: Valve ClosedPalletCount (r:1 w:1)
	fn open_pallet_gate() -> Weight {
		Weight::from_ref_time(25_467_000 as u64)
			.saturating_add(T::DbWeight::get().reads(4 as u64))
			.saturating_add(T::DbWeight::get().writes(2 as u64))
	}
	// Storage: TechnicalMembership Members (r:1 w:0)
	...
	fn open_pallet_gates() -> Weight {
		Weight::from_ref_time(27_864_000 as u64)
			.saturating_add(T::DbWeight::get().reads(2 as u64))
	...
	fn stop_scheduled_tasks() -> Weight {
		Weight::from_ref_time(19_909_000 as u64)
			.saturating_add(T::DbWeight::get().reads(2 as u64))
			.saturating_add(T::DbWeight::get().writes(1 as u64))
	}
	// Storage: TechnicalMembership Members (r:1 w:0)
	// Storage: AutomationTime Shutdown (r:1 w:1)
	fn start_scheduled_tasks() -> Weight {
		Weight::from_ref_time(20_643_000 as u64)
			.saturating_add(T::DbWeight::get().reads(2 as u64))
			.saturating_add(T::DbWeight::get().writes(1 as u64))
	}
}
