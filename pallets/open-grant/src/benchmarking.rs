...
benchmarks! {
	...
	finalize_round {
		...
		OpenGrant::<T>::schedule_round(<T as frame_system::Config>::Origin::from(RawOrigin::Root), 100u32.into(), 200u32.into(), 10u32.into(), vec![0])?;
		frame_system::Pallet::<T>::set_block_number(150u32.into());
		OpenGrant::<T>::contribute(caller_origin.clone(), 0, 100u32.into())?;
	...
	approve {
		...
		OpenGrant::<T>::contribute(caller_origin.clone(), 0, 100u32.into())?;
		frame_system::Pallet::<T>::set_block_number(210u32.into());
		OpenGrant::<T>::finalize_round(<T as frame_system::Config>::Origin::from(RawOrigin::Root), 0)?;
	}: _(RawOrigin::Root, 0, 0)
	...
	withdraw {
		...
		frame_system::Pallet::<T>::set_block_number(210u32.into());
		OpenGrant::<T>::finalize_round(<T as frame_system::Config>::Origin::from(RawOrigin::Root), 0)?;
		OpenGrant::<T>::approve(<T as frame_system::Config>::Origin::from(RawOrigin::Root), 0, 0)?;
