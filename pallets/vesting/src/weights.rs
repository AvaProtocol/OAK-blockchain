...
pub struct pallet_vestingWeight<T>(PhantomData<T>);
impl<T: frame_system::Config> WeightInfo for pallet_vestingWeight<T> {
	...
	fn vest(v: u32, ) -> Weight {
		(14_865_000 as Weight)
			// Standard Error: 29_000
			.saturating_add((20_898_000 as Weight).saturating_mul(v as Weight))
