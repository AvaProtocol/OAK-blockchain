...
pub type ChainSpec = sc_service::GenericChainSpec<turing_runtime::RuntimeGenesisConfig, Extensions>;
...
fn testnet_genesis(
	...
	turing_runtime::RuntimeGenesisConfig {
		...
		polkadot_xcm: turing_runtime::PolkadotXcmConfig {
			safe_xcm_version: Some(SAFE_XCM_VERSION),
			..Default::default()
		},
		transaction_payment: Default::default(),
		sudo: turing_runtime::SudoConfig { key: Some(root) },
	}
}
