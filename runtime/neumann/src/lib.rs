...
use frame_support::{
	...
	traits::{Currency, Everything, Imbalance, Nothing, OnUnbalanced},
	weights::{
...
// Author struct, implementing on_nonzero_unbalanced() (used to pay fees to author)
pub struct Author;
